public class PersonInfo4 {
    ...
    public static String firstName = "Tiffany";
    public static String lastName = "Maynard";
    public static int studentNo = 300047456;
    public static String description = "Un peu sur moi... rien?";
